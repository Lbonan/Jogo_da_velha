...
let vBoard = [];
let turnPlayer = "";
let imgVitoria = "<img src=./img/aprovado.png  alt = cara feliz />";
const spanVitoria = '<span class="resultado aprovado">Aprovado</span>';
...
function handleWin(regions) {
  ...
  document.querySelector("h2").innerHTML = playerName + " venceu!" + imgVitoria;
}
